# Gap status — `mycelium-doc`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-doc` |
| **Role** | myc-doc pipeline |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-doc-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | none |
| **Related issues** | Doc-IR projection |
